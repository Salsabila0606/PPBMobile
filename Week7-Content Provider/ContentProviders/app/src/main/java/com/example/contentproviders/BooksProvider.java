...
import android.util.Log;
    ...
    public class BooksProvider extends ContentProvider {
        ...
        @Override
        public String getType(Uri uri) {  //Returns the MIME type of data at the given URI
        ...
        public Uri insert(Uri uri, ContentValues values) {
            ...
            if (rowID>0)
            {
                ...
                getContext().getContentResolver().notifyChange(_uri, null); //inserted success
                return _uri;
            }
        ...
        @Override
        public boolean onCreate() {  //called when started | open a connection to db
        ...
        @Override //request from client, returned as cursor object | query for books
